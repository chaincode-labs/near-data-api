select emitted_by_contract_account_id as token_id, count(*) transaction_count, sum(amount::NUMERIC)::text as transaction_amount from assets__fungible_token_events
